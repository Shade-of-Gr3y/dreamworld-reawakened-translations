...
def GET_my_croft_list(_query):
    return(json.dumps(utility.crops.data).encode())
...
def POST_kinomi_harvesting(_query):
    ...
    harvest_result = utility.crops.harvest(my_croft_id)
    utility.chest.add_item(harvest_result["pokeitem_id"], harvest_result["count"])
...
def POST_kinomi_watering(_query):
    ...
    utility.crops.water_plot(my_croft_id)
